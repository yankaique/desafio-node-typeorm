...
class ImportTransactionsService {
  async execute(filePath: string): Promise<Transaction[]> {
    ...
    const contactReadStrean = fs.createReadStream(filePath);
    ...
    const parseCSV = contactReadStrean.pipe(parsers);
    ...
    const addCategoryTitles = categories
      .filter(category => !existenceCategoriesTitles.includes(category))
